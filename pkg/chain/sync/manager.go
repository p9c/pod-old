...
func (
	...
	block *util.Block, flags blockchain.BehaviorFlags) (bool, error) {
...
func (
	...
	block *util.Block, peer *peerpkg.Peer, done chan struct{}) {
...
func (
	...
	headers *wire.MsgHeaders, peer *peerpkg.Peer) {
...
func (
	...
	inv *wire.MsgInv, peer *peerpkg.Peer) {
...
func (
	...
	tx *util.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
func (
	...
	log <- cl.Inf("sync manager shutting down")
	close(sm.quit)
	sm.wg.Wait()
	return nil
}
...
func (
	...
	newestHash *chainhash.Hash, newestHeight int32) {
...
func (
	...
	for peer, state := range sm.peerStates {
		...
		if segwitActive && !peer.IsWitnessEnabled() {
			...
			log <- cl.Debug{"peer", peer, "not witness enabled, skipping"}
			continue
		}
