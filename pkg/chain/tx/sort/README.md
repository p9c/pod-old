...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/git.parallelcoin.io/dev/pod/btcutil/txsort)
...
```bash
$ go get -u git.parallelcoin.io/dev/pod/btcutil/txsort
```
