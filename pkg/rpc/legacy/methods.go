...
// appropiate error.
func unimplemented(
	interface{}, *wallet.Wallet) (interface{}, error) {
...
func makeMultiSigScript(
	w *wallet.Wallet, keys []string, nRequired int) ([]byte, error) {
...
// and amounts.
func makeOutputs(
	pairs map[string]util.Amount, chainParams *chaincfg.Params) ([]*wire.TxOut, error) {
