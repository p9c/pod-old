...
[![GoDoc](https://godoc.org/github.com/parallelcointeam/mod/walletdb?status.png)]
(http://godoc.org/github.com/parallelcointeam/mod/walletdb)
...
http://localhost:6060/pkg/github.com/parallelcointeam/mod/walletdb

## Installation

```bash
$ go get github.com/parallelcointeam/mod/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/parallelcointeam/mod/walletdb#example-package--BasicUsage)  
