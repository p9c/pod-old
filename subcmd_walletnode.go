...
type walletnodeCfgRPCGroup struct {
...
type walletnodeCfgP2PGroup struct {
...
type walletnodeCfgChainGroup struct {
...
type walletnodeCfgLaunchGroup struct {
...
type walletnodeCfgMiningGroup struct {
...
type walletnodeCfg struct {
	LaunchGroup    walletnodeCfgLaunchGroup `group:"launch options"`
	NodeRPCGroup   walletnodeCfgRPCGroup    `group:"node RPC options"`
	NodeP2PGroup   walletnodeCfgP2PGroup    `group:"node P2P options"`
	NodeChainGroup walletnodeCfgChainGroup  `group:"node chain options"`
	MiningGroup    walletnodeCfgMiningGroup `group:"node mining options"`
