...
[![GoDoc](https://godoc.org/git.parallelcoin.io/pod/waddrmgr?status.png)](http://godoc.org/git.parallelcoin.io/pod/waddrmgr)

Full `go doc` style documentation for the project can be viewed online without
installing this package by using the GoDoc site here:
http://godoc.org/github.com/git.parallelcoin.io/pod/waddrmgr

You can also view the documentation locally once the package is installed with
the `godoc` tool by running `godoc -http=":6060"` and pointing your browser to
http://localhost:6060/pkg/git.parallelcoin.io/pod/waddrmgr

## Installation

```bash
$ go get git.parallelcoin.io/pod/waddrmgr
```

Package waddrmgr is licensed under the [copyfree](http://copyfree.org) ISC License.
