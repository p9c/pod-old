...
// TestHelp ensures the help is reasonably accurate by checking that every command specified also has result types defined and the one-line usage and help text can be generated for them.
