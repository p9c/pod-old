...
func ExamplePayToAddrScript() {
	// Parse the address to send the coins to into a btcutil.Address which is useful to ensure the accuracy of the address and determine the address type.  It is also required for the upcoming call to
	// PayToAddrScript.
