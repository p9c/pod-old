...
https://github.com/parallelcointeam/mod/releases
...
```
git clone https://github.com/parallelcointeam/mod $GOPATH/src/github.com/parallelcointeam/mod
cd $GOPATH/src/github.com/parallelcointeam/mod
glide install
```
...
The [integrated github issue tracker](https://github.com/parallelcointeam/mod/issues)
