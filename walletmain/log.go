...
import (
	...
	"git.parallelcoin.io/pod/walletmain/chain"
	"git.parallelcoin.io/pod/walletmain/rpc/legacyrpc"
	"git.parallelcoin.io/pod/walletmain/rpc/rpcserver"
	"git.parallelcoin.io/pod/walletmain/wallet"
	"git.parallelcoin.io/pod/walletmain/wtxmgr"
...
var subsystemLoggers = map[string]l.Logger{
	"DUOW": log,
	"WLLT": walletLog,
	"TMGR": txmgrLog,
	"CHNS": chainLog,
...
func setLogLevel(subsystemID string, logLevel string) {
	...
	level, _ := l.LevelFromString(logLevel)
