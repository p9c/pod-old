...
[![GoDoc](https://godoc.org/git.parallelcoin.io/pod/walletmain/waddrmgr?status.png)]
(http://godoc.org/git.parallelcoin.io/pod/walletmain/waddrmgr)
...
http://localhost:6060/pkg/git.parallelcoin.io/pod/walletmain/waddrmgr

## Installation

```bash
$ go get git.parallelcoin.io/pod/walletmain/waddrmgr
```
