...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/parallelcointeam/pod/coinset)
...
```bash
$ go get -u github.com/parallelcointeam/pod/coinset
```
